...
try {
  ...
  setOutput("⚠️ Failed to process. Check API / backend.");
}
...
return ( <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white">
  ...
  <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto mt-14 px-6">
    ...
    <div className="bg-white/5 backdrop-blur-xl p-6 rounded-2xl border border-white/10 shadow-2xl flex flex-col justify-between">
      ...
      <div className="flex gap-5 justify-center mt-6">
        ...
        <button
          onClick={()=>{setInput("");setOutput("");setDisplay("");}}
